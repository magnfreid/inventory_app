...
mixin _$CatalogueState {
 ...
 CatalogueStateStatus get status; List<CatalogueItem> get items; CatalogueStateSaveStatus get saveStatus;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CatalogueState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.saveStatus, saveStatus) || other.saveStatus == saveStatus));
}
...
@override
String toString() {
  return 'CatalogueState(status: $status, items: $items, saveStatus: $saveStatus)';
}
...
@useResult
$Res call({
 CatalogueStateStatus status, List<CatalogueItem> items, CatalogueStateSaveStatus saveStatus
});
...
as List<CatalogueItem>,saveStatus: null == saveStatus ? _self.saveStatus : saveStatus // ignore: cast_nullable_to_non_nullable
as CatalogueStateSaveStatus,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CatalogueStateStatus status,  List<CatalogueItem> items,  CatalogueStateSaveStatus saveStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CatalogueState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CatalogueStateStatus status,  List<CatalogueItem> items,  CatalogueStateSaveStatus saveStatus)  $default,) {final _that = this;
switch (_that) {
case _CatalogueState():
return $default(_that.status,_that.items,_that.saveStatus);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CatalogueStateStatus status,  List<CatalogueItem> items,  CatalogueStateSaveStatus saveStatus)?  $default,) {final _that = this;
switch (_that) {
case _CatalogueState() when $default != null:
return $default(_that.status,_that.items,_that.saveStatus);case _:
  return null;
...
class _CatalogueState extends CatalogueState {
  const _CatalogueState({this.status = CatalogueStateStatus.loading, final  List<CatalogueItem> items = const [], this.saveStatus = CatalogueStateSaveStatus.idle}): _items = items,super._();
...
@override@JsonKey() final  CatalogueStateSaveStatus saveStatus;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CatalogueState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.saveStatus, saveStatus) || other.saveStatus == saveStatus));
}
