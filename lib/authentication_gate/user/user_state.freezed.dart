...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( Exception error)?  error,TResult Function( User currentUser)?  loaded,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Error() when error != null:
return error(_that.error);case _Loaded() when loaded != null:
return loaded(_that.currentUser);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( Exception error)  error,required TResult Function( User currentUser)  loaded,}) {final _that = this;
switch (_that) {
case _Loading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( Exception error)?  error,TResult? Function( User currentUser)?  loaded,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Error() when error != null:
return error(_that.error);case _Loaded() when loaded != null:
...
class _Loaded implements UserState {
  const _Loaded({required this.currentUser});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&(identical(other.currentUser, currentUser) || other.currentUser == currentUser));
}
...
@override
String toString() {
  return 'UserState.loaded(currentUser: $currentUser)';
}
