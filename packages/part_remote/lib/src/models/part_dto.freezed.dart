...
/// Part name
 String get name;/// Unique detail / part number
 String get detailNumber;/// Whether the part is made from recycled materials
 bool get isRecycled;/// Price of the part
 double get price;/// Optional category tag ID
 String? get categoryTagId;/// Optional brand tag ID
 String? get brandTagId;/// Optional part description
 String? get description;/// List of general tag IDs
 List<String> get generalTagIds;/// Optional image path / URL
 String? get imgPath;/// Optional thumbnail image path / URL
 String? get thumbnailPath;/// Optional unique ID (used when received from backend)
 String? get id;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,detailNumber,isRecycled,price,categoryTagId,brandTagId,description,const DeepCollectionEquality().hash(generalTagIds),imgPath,thumbnailPath,id);

@override
String toString() {
  return 'PartDto(name: $name, detailNumber: $detailNumber, isRecycled: $isRecycled, price: $price, categoryTagId: $categoryTagId, brandTagId: $brandTagId, description: $description, generalTagIds: $generalTagIds, imgPath: $imgPath, thumbnailPath: $thumbnailPath, id: $id)';
}
...
@useResult
$Res call({
 String name, String detailNumber, bool isRecycled, double price, String? categoryTagId, String? brandTagId, String? description, List<String> generalTagIds, String? imgPath, String? thumbnailPath, String? id
});
...
/// Create a copy of PartDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? detailNumber = null,Object? isRecycled = null,Object? price = null,Object? categoryTagId = freezed,Object? brandTagId = freezed,Object? description = freezed,Object? generalTagIds = null,Object? imgPath = freezed,Object? thumbnailPath = freezed,Object? id = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String detailNumber,  bool isRecycled,  double price,  String? categoryTagId,  String? brandTagId,  String? description,  List<String> generalTagIds,  String? imgPath,  String? thumbnailPath,  String? id)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PartDto() when $default != null:
return $default(_that.name,_that.detailNumber,_that.isRecycled,_that.price,_that.categoryTagId,_that.brandTagId,_that.description,_that.generalTagIds,_that.imgPath,_that.thumbnailPath,_that.id);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String detailNumber,  bool isRecycled,  double price,  String? categoryTagId,  String? brandTagId,  String? description,  List<String> generalTagIds,  String? imgPath,  String? thumbnailPath,  String? id)  $default,) {final _that = this;
switch (_that) {
case _PartDto():
return $default(_that.name,_that.detailNumber,_that.isRecycled,_that.price,_that.categoryTagId,_that.brandTagId,_that.description,_that.generalTagIds,_that.imgPath,_that.thumbnailPath,_that.id);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String detailNumber,  bool isRecycled,  double price,  String? categoryTagId,  String? brandTagId,  String? description,  List<String> generalTagIds,  String? imgPath,  String? thumbnailPath,  String? id)?  $default,) {final _that = this;
switch (_that) {
case _PartDto() when $default != null:
return $default(_that.name,_that.detailNumber,_that.isRecycled,_that.price,_that.categoryTagId,_that.brandTagId,_that.description,_that.generalTagIds,_that.imgPath,_that.thumbnailPath,_that.id);case _:
  return null;
...
class _PartDto extends PartDto {
  const _PartDto({required this.name, required this.detailNumber, required this.isRecycled, required this.price, required this.categoryTagId, required this.brandTagId, required this.description, required final  List<String> generalTagIds, required this.imgPath, required this.thumbnailPath, required this.id}): _generalTagIds = generalTagIds,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,detailNumber,isRecycled,price,categoryTagId,brandTagId,description,const DeepCollectionEquality().hash(_generalTagIds),imgPath,thumbnailPath,id);
...
/// Create a copy of PartDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? detailNumber = null,Object? isRecycled = null,Object? price = null,Object? categoryTagId = freezed,Object? brandTagId = freezed,Object? description = freezed,Object? generalTagIds = null,Object? imgPath = freezed,Object? thumbnailPath = freezed,Object? id = freezed,}) {
